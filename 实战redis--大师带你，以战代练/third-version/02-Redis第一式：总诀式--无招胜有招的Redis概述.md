...
> **江湖规矩**：本系列若无特别声明，「大师」负责甩锅给架构，「小白」负责踩坑给观众看——均为艺术加工，请勿对号入座到你的直属领导。
...
3. Redis 支持多种数据结构：字符串、散列表、列表、集合、有序集合（含范围查询），以及**按位操作的位图**、**HyperLogLog**、**带半径查询的地理位置索引**、**Stream** 等；
...
**大师**：（忽然回头）且慢。江湖上还有一门旁门左道，叫作「面向搜索引擎习武」——你可曾练过？

**小白**：（声如蚊蚋）……偶有涉猎。

**大师**：无妨。从今日起，你把官网那段英文总诀抄写百遍，抄到看见 `LRU` 不再脑补成「路人」为止。
...
**大师**：睡。梦里若见到单线程与多线程打架，记得醒来查文档——多半是 I/O 线程与命令线程在吵。

---

**收式**

**小白**：弟子明日便把总诀译成中文便签，贴显示器边上——英文原句也留着，免得和官网文档对不上号。

**大师**：善。**总诀是地图，不是终点**；后九式每一招，都要回来对照这句英文里出现的关键词。
