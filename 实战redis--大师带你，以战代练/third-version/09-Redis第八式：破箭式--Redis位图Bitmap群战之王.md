...
> **兵器谱注**：Bitmap 在命令表里归在 String 门下，却擅长「听风辨器」——位上为 1，便当作箭已掠过。别问为何不叫 Bitmap 式，问就是归类办当年笔误至今懒得改。
...
**小白**：大师，布隆说「可能存在」时，弟子总怕误伤好人……

**大师**：它误伤的是「假阳性」，不是误删库；说「一定不存在」时倒是清白。把这句背熟，比背布隆公式更能保你半夜不被叫起。
